<template>
  <main id="PrivacyPage">
    ...
    <p>
      Diese Webseite nutzt eine Cloud-Plattform für virtuelle Server von Digital Ocean LLC, 106 6th Avenue, New York
      USA. Der Serverstandort ist ein ISO/IEC 27001 zertifiziertes Rechenzentrum in Frankfurt, in welchem Digital Ocean
      Stellplätze anmietet.
    </p>
    <p>
      Der Einsatz von Digital Ocean beruht auf unserem berechtigten Interesse an einer möglichst fehlerfreien und
      sicheren Bereitstellung unseres Webangebotes (Art. 6 Abs. 1 lit. f DSGVO). Die Datenübertragung indie USA wird auf
      die neuen Standardvertragsklauseln der EU-Kommission gestützt. Details findest Du hier: <br />
    ...
    <h3>Allgemeine Hinweise zu den Rechtsgrund<wbr />lagen der Datenverar<wbr />beitung auf dieser Website</h3>
    <p>
      ...
      Device-Fingerprinting) eingewilligt haben, erfolgt die Datenverarbeitung zusätzlich auf Grundlage von § 25 Abs. 1
      TTDSG. Die Einwilligung ist jederzeit widerrufbar. Sind Ihre Daten zur Vertragserfüllung oder zur Durchführung
    ...
    <h3>Widerruf Ihrer Einwilligung zur Datenverar<wbr />beitung</h3>
    <p>
    ...
    <h3>
      Widerspruchs<wbr />recht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)
    </h3>
    <p>
